...
ActiveRecord::Schema.define(version: 2019_09_26_175423) do
  ...
  create_table "mailboxer_conversation_opt_outs", force: :cascade do |t|
    ...
    t.index ["unsubscriber_type", "unsubscriber_id"], name: "index_mailboxer_conversation_opt_outs_on_unsubscriber_id_type"
  end
  ...
  create_table "spree_line_items", force: :cascade do |t|
    ...
    t.index ["owner_id"], name: "index_spree_line_items_on_owner_id"
  ...
  create_table "spree_stock_locations", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_spree_stock_locations_on_user_id"
  end
  ...
  create_table "spree_wished_products", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_spree_wished_products_on_user_id"
